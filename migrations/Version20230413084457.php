 ...
 */
final class Version20230413084457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiest DROP optreden_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiest ADD optreden_id INT NOT NULL');
    }
}
